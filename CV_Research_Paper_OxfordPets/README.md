...
Google drive link for the models and results: https://drive.google.com/drive/folders/19LX_tUojVIog0ZItmfmyHYstJAWIXnJ8?usp=sharing
...
└── Stage 4: Benchmarking and Demo/
    └── CV_Research_Paper_OxfordPets_analysis.zip/
        ├── eda_outputs/             (eda.py)
