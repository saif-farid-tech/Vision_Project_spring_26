"""
finetune_shvit_fgvc_aircraft.py

Single-GPU wrapper for fine-tuning SHViT (S1..S4) on FGVC Aircraft.
...
Usage:
    python finetune_shvit_fgvc_aircraft.py \\
...
def get_args():
    p = argparse.ArgumentParser("SHViT FGVC Aircraft fine-tuning (single GPU)")
    ...
    p.add_argument("--output-dir",  type=Path,
                   default=Path("CV_Research_Paper_FGVCAircraft/Stage 3: fine-tuning SHViT/shvit_s4"))
