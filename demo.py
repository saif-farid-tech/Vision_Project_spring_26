"""
demo.py
Single-image inference with SHViT-S4 fine-tuned on FGVC Aircraft.
...
def main():
    ...
    p.add_argument("--data-root",  type=Path, required=True,
                   help="FGVC Aircraft parent dir (used to fetch the class names)")
    p.add_argument("--output",     type=Path,
                   default=Path("CV_Research_Paper_FGVCAircraft/Stage 4: Benchmarking and Demo/analysis/demo_output/demo_output.png"))
