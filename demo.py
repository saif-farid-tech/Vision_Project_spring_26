"""
demo.py
Single-image inference with SHViT-S4 fine-tuned on SUN397.
...
def main():
    ...
    p.add_argument("--data-root",  type=Path, required=True,
                   help="SUN397 parent dir (used to fetch the class names)")
    p.add_argument("--output",     type=Path,
                   default=Path("CV_Research_Paper_SUN397/Stage 4: Benchmarking and Demo/analysis/demo_output/demo_output.png"))
