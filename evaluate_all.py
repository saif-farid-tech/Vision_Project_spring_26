"""
evaluate_all.py
Run inference and benchmarks for the 6 trained Oxford Pets classifiers
(ResNet-50, MobileNetV2, SHViT-S1..S4) on the held-out Oxford Pets test split
(from the Tip-Adapter split_zhou_OxfordPets.json).
...
Usage:
    python evaluate_all.py \\
        --checkpoints-dir CV_Research_Paper_OxfordPets \\
        --shvit-dir       SHViT \\
        --data-root       data \\
        --output-dir      CV_Research_Paper_OxfordPets/Stage\\ 4:\\ Benchmarking\\ and\\ Demo/analysis/results
"""
...
def main():
    ...
    # ---- Test set (Oxford Pets Tip-Adapter split) -----------------------
