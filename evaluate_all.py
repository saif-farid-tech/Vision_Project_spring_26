"""
evaluate_all.py
Run inference and benchmarks for the 6 trained UCF101 classifiers
(ResNet-50, MobileNetV2, SHViT-S1..S4) on the held-out UCF101 test split
(from the Tip-Adapter split_zhou_UCF101.json).
...
Usage:
    python evaluate_all.py \\
        --checkpoints-dir CV_Research_Paper_UCF101 \\
        --shvit-dir       SHViT \\
        --data-root       data \\
        --output-dir      CV_Research_Paper_UCF101/Stage\\ 4:\\ Benchmarking\\ and\\ Demo/analysis/results
"""
...
def main():
    ...
    # ---- Test set (UCF101 Tip-Adapter split) -----------------------
