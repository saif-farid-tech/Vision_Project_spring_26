"""
train_baseline.py
Fine-tune ResNet-50 or MobileNetV2 on UCF101 as a baseline for SHViT.

Splits: UCF101 train / val / test as defined by the Tip-Adapter style
        `split_zhou_UCF101.json` (downloaded or auto-generated by
        prepare_ucf101.py).  The test split is reserved for Stage 4's
...
def train_one_epoch(model, loader, criterion, optimizer, scaler, device, mixup_fn, clip_grad):
    """Matches the SHViT recipe in finetune_shvit_ucf101.py."""
    model.train()
    total_loss, n = 0.0, 0
...
def main():
    ...
    parser.add_argument("--output-dir",
                        default="CV_Research_Paper_UCF101/Stage 2: baseline models")
