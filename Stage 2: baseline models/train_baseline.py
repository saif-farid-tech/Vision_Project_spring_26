"""
train_baseline.py
Fine-tune ResNet-50 or MobileNetV2 on DTD as a baseline for SHViT.

Splits: DTD train / val / test as defined by the Tip-Adapter style
        `split_zhou_DescribableTextures.json` (downloaded or auto-generated by
        prepare_dtd.py).  The test split is reserved for Stage 4's
...
def train_one_epoch(model, loader, criterion, optimizer, scaler, device, mixup_fn, clip_grad):
    """Matches the SHViT recipe in finetune_shvit_dtd.py."""
    model.train()
    total_loss, n = 0.0, 0
...
def main():
    ...
    parser.add_argument("--output-dir",
                        default="CV_Research_Paper_DTD/Stage 2: baseline models")
